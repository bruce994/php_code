...
$body = GetPage("http://waiwai.com.au/m/2010/0402/mail.html");
$title = "LOVE MI 鄭秀文悉尼演唱會門票火爆預訂ING~（98門票獨家發售）";

$db = new Database("02.waiwai.com.au:17909","waiwai_uc","vm3hFncBi2DS","waiwai_uc");

//var_dump(SendMail($title,$body,'kenyo.wu@waiwai.com.au,zhen.wang@waiwai.com.au',"kenyo,wang","","",$server,$port,$username,$password,true));
//exit;
